...
* [Grokking Continuous Delivery](https://www.manning.com/books/grokking-continuous-delivery) - A book that teaches the design and purpose of continuous delivery systems that can be used with any language or stack.
